...
\begin{frame}{A Two-Player Black-Box Test for VQA}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{assets/thesis-fig-2-1-two-player-game}
  \end{center}
...
\begin{frame}{Visual Chapter: Qualitative Failures}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{assets/thesis-fig-2-2-visual-failures}
  \end{center}
