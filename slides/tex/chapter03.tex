...
% Slide 10: Exposing and Mitigating Biases in Code Generation
...
\begin{frame}{Code Chapter: What Breaks When Hints Disappear}
  \begin{columns}
    ...
    \vspace{-0.3em}
    {\tiny Source: ACL 2023 Table 3 (cropped)}
  \end{columns}
...
\begin{frame}{Code Chapter: Qualitative Examples of Shallow Reasoning}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.7\textwidth,height=0.5\textheight,keepaspectratio]{assets/thesis-fig-3-2-code-failures}
    \vspace{-0.3em}
    {\tiny Source: Thesis Fig. 3.2 (code failure examples)}
  \end{center}
...
\begin{frame}{What Helped in Code Generation}
  \begin{columns}
    ...
    \vspace{-0.3em}
    {\tiny Source: ACL 2023 Tables 4-5 (mitigation results)}
