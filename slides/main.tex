...
% --- Chapters ---
\input{tex/chapter01}  % Introduction (Slides 3-4: Clever Hans, Research Question)
\input{tex/chapter02}  % Visual Domain (Slides 5-9)
\input{tex/chapter03}  % Code Generation (Slides 10-14)
\input{tex/chapter04}  % Geometric Reasoning (Slides 15-20, includes calibration slide)
\input{tex/chapter05}  % Conclusions (Slide 22, updated)

% --- Synthesis and Closing ---
\input{tex/synthesis}  % Cross-domain synthesis (Slide 21)
\input{tex/closing}    % Closing takeaway and thank you (Slides 23-24)
